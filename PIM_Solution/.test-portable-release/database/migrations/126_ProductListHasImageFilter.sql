/*
  126 — filter »ima sliko« na delovnem seznamu izdelkov.

  Zahteva uporabnika 2026-08-28: »Pri filtrih je treba dodati ali ima sliko ali ne.«

  Doslej je bila slika dosegljiva samo prek shranjenega pogleda NO_IMAGE, ki je izkljucujoc z
  vsemi ostalimi pogledi — izdelkov brez slike ni bilo mogoce kriziti z »blokirani za splet«
  ali s posameznim dobaviteljem. Filter je zato pravi parameter, ne pogled: sestavlja se z
  vsemi ostalimi. Pogled NO_IMAGE ostane kot bliznjica z ze prikazanim stevcem.

  Merilo je isto kot pri pogledu NO_IMAGE in pri stolpcu MediaCount — obstoj vrstice v
  canon.ProductMedia. Drugega merila za »ima sliko« v modelu ni.

  Pogoj je dodan v obe poizvedbi procedure: v stran rezultatov in v stevec, sicer bi
  stevilo zadetkov in seznam govorila vsak svoje.
