/*
  128 — kartica izdelka dobi ime dobavitelja in proizvajalca.

  Zahteva uporabnika 2026-08-28:

    »Pri kartici artikla kjer so dobavitelji in pa proizvajalci je treba se dodati ime
     dobavitleja in proizvajalca, da se oboje vidi ime in kodo«

  Na seznamu izdelkov je bilo to reseno ze z migracijo 115 prek pogleda canon.PartnerName
  (imena istih sifer iz b2b.Customer — isti sifrant partnerjev iz SAOP). Kartica je ostala
  pri golih sifrah. Ta migracija doda oba stolpca se v intranet.GetProductCard: isti pogled,
  isti vir, nobene kopije imena v canon.Product.

  Sifra ostane, ker ona potuje nazaj v SAOP; ime stoji ob njej. Kjer imena ni, ostane sifra
  sama — izmisljati je ne gre.
...
BEGIN
  ...
  SELECT product.ProductId, product.ItemID,
    ...
    /* 128: kartica je kazala samo sifri partnerjev. Sifra gre nazaj v SAOP, zato ostane,
       ime pa je to, kar clovek prebere. Isti pogled kot na seznamu izdelkov (migracija 115). */
