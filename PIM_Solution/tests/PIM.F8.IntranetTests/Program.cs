...
foreach (var label in new[] { "Cilj", "Operacija", "Entiteta", "Polja", "Dedup ključ", "Stanje", "Poskusi", "Naslednji poskus", "Odziv", "Odklon", "Odobri", "Prekliči", "Ponovi" })
  Contains(page, label, $"Manjka slovenska oznaka {label}.");
foreach (var procedure in new[] { "intranet.GetOutboundMessages", "out.ApproveMessage", "out.CancelMessage", "out.RetryMessage" })
