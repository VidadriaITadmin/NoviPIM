...
public static class WorkerJobs
{
  ...
  [
    new("magento-csv", GroupCycles, "CSV za Magento",
      "Preveri podatke PIM-a in izdela katalog.csv ter stranke.csv. Samostojen izhod brez zajema iz SAOP in brez pisanja v SAOP.",
      WorkerJobKind.Cycle, WorkerCycles.Magento, [], false, null,
      WorkerJobReach.Internal, null, ["MAGENTO_PRODUCTS"], "magento-csv"),
    ...
    new("katalog-cikel", GroupCycles, "Zajem kataloga in naročil",
      "Vhod iz SAOP, validacija in objava v PIM. Datoteki za Magento izdeluje ločen cikel CSV za Magento.",
      WorkerJobKind.Cycle, WorkerCycles.Katalog, [], false, null,
      WorkerJobReach.ExternalCall, "kliče SAOP", ["SAOP_PRODUCTS", "SAOP_ORDERS_VNK", "SAOP_ORDERS_VND"], "katalog-"),
  ...
  [
    ...
    ("PIM magento", "magento-", "magento-csv"),
  ];
...
public static partial class WorkerLogs
{
  ...
  [
    ("opravila", "Opravila (gostitelj avtomatike)", "opravila" + Path.DirectorySeparatorChar),
    ("gostitelj", "Gostitelj avtomatike", "gostitelj" + Path.DirectorySeparatorChar),
  ...
  // Ključ posla (237) je velik z vezaji spodaj (SAOP_PRODUCT_IMPORT_2026-…), ključ ročnega zagona majhen z vezaji.
  [GeneratedRegex(@"^(?<key>[A-Za-z0-9_-]+?)_(?<t>\d{4}-\d{2}-\d{2}_\d{6})\.log$")]
