...
| `ProductWorkbookService.BuildAsync` | `intranet.GetProductList` + `intranet.GetProductWorkbook` (migraciji 171 in 173; šest naborov: vrednosti polj, kategorije po straneh, atributi, slike, šifrant atributov, register zahtevanih polj) | `/izvoz/izdelki.xlsx?predloga=delovni` |
