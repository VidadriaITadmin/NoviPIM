...
| **Izhodi → Izhod v SAOP** | `/saop` | `ADMIN`, `CATALOG_EDITOR` | `/saop/artikli` (nov artikel ali sprememba iz Excela → čakalna lista), `/saop/zgodovina`, `/saop/odkloni`, `/saop/polja`; `/outbound` (odobri / prekliči / ponovi); `/izvozi/mnozicno`, `/izvozi/obvestila` |
